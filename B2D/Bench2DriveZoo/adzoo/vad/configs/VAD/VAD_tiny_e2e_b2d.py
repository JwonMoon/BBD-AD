...
# Name mapping for Bench2Drive dataset
NameMapping = {
    #=================vehicle=================
    # bicycle
...
# map has classes specific to Bench2Drive
...
total_epochs = 6  # Reduced to match VAD_base_e2e_b2d.py
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        valid_fut_ts=6,
        ego_fut_mode=6,  # Added to match VAD_base_e2e_b2d.py
            ...
            transformerlayers=dict(
                ...
                attn_cfgs=[
                    dict(
                        ...
                        embed_dims=_dim_,
                        num_heads=8,
                        dropout=0.0),  # Reduced dropout to match VAD_base_e2e_b2d.py
                ],
                feedforward_channels=_ffn_dim_,
                ffn_dropout=0.0,  # Reduced dropout
    ...
    train_cfg=dict(pts=dict(
        ...
        assigner=dict(
            ...
            iou_cost=dict(type='IoUCost', weight=0.0),  # Fake cost for DETR compatibility
            pc_range=point_cloud_range),
        map_assigner=dict(
...
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=6,  # Increased to match VAD_base_e2e_b2d.py
    train=dict(
        type=dataset_type,
        data_root=data_root,
...
lr_config = dict(
    by_epoch=False,  # Added to match VAD_base_e2e_b2d.py
...
log_config = dict(
    interval=50,  # Adjusted to match VAD_base_e2e_b2d.py
    hooks=[
