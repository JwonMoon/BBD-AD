...
class ScenarioManager(object):
    ...
    def __init__(self, timeout, statistics_manager, debug_mode=0):
        ...
        # self._tick_trigger_sub = self.create_subscription(TickTrigger, '/tcp/tick_trigger', self._tick_trigger_callback, QoSProfile(depth=1))
    ...
    def _tick_simulation(self, step):
        """
        Run next tick of scenario and the agent and tick the world.
        """        
        print("[scenario_manager] 1. _tick_simulation() called")
