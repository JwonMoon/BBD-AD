...
if len(sys.argv) != 2:
    print("usage: python draw_gpu.py <eval file name>")
    sys.exit(1)
...
images_folder = '/root/shared_dir/BBD-AD/jw_ws/eval_v1/' + file_name
output_video = '/root/shared_dir/BBD-AD/jw_ws/output/video/' + file_name + '.mp4'
# fps = 15
