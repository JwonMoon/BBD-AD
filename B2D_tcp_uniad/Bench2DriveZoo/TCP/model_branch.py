...
class TCPBranch(nn.Module):
	...
	def forward(self, cnn_feature, measurement_feature, traj_hidden_state):
		timing = {}
		outputs = {}
		...
		t5 = time.time()
		timing['future_feature_action'] = (t5- t4)*1000
