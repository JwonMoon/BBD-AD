...
bool bbd_msgs__msg__bbd_branch_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bbd_msgs.msg._bbd_branch_output.BBDBranchOutput", full_classname_dest, 47) == 0);
  }
  bbd_msgs__msg__BBDBranchOutput * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BBDBranchOutput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("bbd_msgs.msg._bbd_branch_output");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BBDBranchOutput");
