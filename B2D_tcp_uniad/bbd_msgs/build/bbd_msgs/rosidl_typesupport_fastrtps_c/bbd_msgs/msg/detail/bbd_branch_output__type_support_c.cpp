...
#include "bbd_msgs/msg/detail/bbd_branch_output__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_bbd_msgs
...
using _BBDBranchOutput__ros_msg_type = bbd_msgs__msg__BBDBranchOutput;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _BBDBranchOutput__ros_msg_type * ros_message = static_cast<const _BBDBranchOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _BBDBranchOutput__ros_msg_type * ros_message = static_cast<_BBDBranchOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_bbd_msgs__msg__BBDBranchOutput(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BBDBranchOutput__ros_msg_type * ros_message = static_cast<const _BBDBranchOutput__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BBDBranchOutput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bbd_msgs__msg__BBDBranchOutput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bbd_msgs
size_t max_serialized_size_bbd_msgs__msg__BBDBranchOutput(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_bbd_msgs__msg__BBDBranchOutput(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_BBDBranchOutput = {
  "bbd_msgs::msg",
  "BBDBranchOutput",
...
static rosidl_message_type_support_t _BBDBranchOutput__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BBDBranchOutput,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bbd_msgs, msg, BBDBranchOutput)() {
  return &_BBDBranchOutput__type_support;
}
