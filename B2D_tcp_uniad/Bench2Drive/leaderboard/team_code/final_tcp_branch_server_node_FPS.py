...
# def start_branch_server(ckpt_path, debug_mode, orin1_ip='localhost', port_recv=9999, port_send=9998):
def start_branch_server(ckpt_path, debug_mode, port_recv=9999):
    rclpy.init()
